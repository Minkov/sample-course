...
| x  | y |
| ---- | ---- |
| [image src="https://github.com/SoftUni/Programming-Basics-Book-CSharp-EN/blob/master/assets/alert-icon.png" | Depending on the regional settings of the operational system, it is possible instead of using a **decimal point** (US settings), to be used a **decimal comma** (BG settings). | 
